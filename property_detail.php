...
<?php
$get_id_property=$mysqli->real_escape_string($_POST['post_item']);
$id_property_sql="SELECT * FROM property WHERE id_property='$get_id_property'";
$id_property_result=$mysqli->query($id_property_sql) or die($mysqli->error);

$id_pro = $_POST['post_item'];


while($row_id_property=$id_property_result->fetch_array()){
